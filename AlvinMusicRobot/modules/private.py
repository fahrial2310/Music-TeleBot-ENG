            ...
            [
                [
                    InlineKeyboardButton(
                        f"➕ Add {BOT_NAME} to your Group ➕", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")],
                [
                    InlineKeyboardButton(
...
def map(pos):
    if(pos==1):
        ...
        button = [
            [InlineKeyboardButton(f"➕ Add {BOT_NAME} to your Group ➕", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")],
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        f"♾ this for {BOT_NAME} help ♾", url=f"https://t.me/{BOT_USERNAME}?start"
                    )
                ]
            ]
        ),
